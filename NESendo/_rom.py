...
class ROM(object):
    ...
    def __init__(self, rom_path):
        ...
        # Note: Zero fill bytes validation removed as many legitimate ROM files
        # have non-zero values in bytes 11-15, which is generally acceptable
    ...
    def prg_rom_size(self):
        ...
        return int(16 * int(self.header[4] & 0xFF))

    @property
    def chr_rom_size(self):
        """Return the size of the CHR ROM in KB."""
        return int(8 * int(self.header[5] & 0xFF))
